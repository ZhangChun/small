...
//					console.log("contentttttt",content)
					...
					case ",":
						...
						document.getElementById('editor2').innerHTML += content;
						let tObj = document.getElementById("editor2");
						let sPos = tObj.innerHTML.length;
				...
				function(t) {
					...
					}), s(f, e(c.emojiBtn), c.position), t.stopPropagation(), m = !1) : (f.hide("slow"), m = !0)
				}),
				e(o).on("click",
				function(t) {
					if (!m) {
